...
function CycleCompleteReport() {
	...
	const handleDownload = async () => {
		...
		try {
			...
			// Fetch the data
			const response = await FetchExcel(`ExcelExport/completionreport?${params.toString()}`);
			...
			link.href = url;
			link.download = `CompletionReport_${selectedProject || 'All'}_${selectedCutting || 'All'}.xlsx`;
...
export default CycleCompleteReport;
