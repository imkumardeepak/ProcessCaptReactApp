...
import Backspace from '@mui/icons-material/ArrowBack';
	...
	return (
		<Card type="section">
			...
			<Grid container rowSpacing={2} columnSpacing={4}>
				...
				<Grid item xs={6} sm={2}>
					<Button variant="contained" fullWidth endIcon={<Save />}>
						Save
					</Button>
				</Grid>
				<Grid item xs={6} sm={2}>
					<Button color="error" variant="outlined" fullWidth startIcon={<Backspace />}>
						Back
					</Button>
				</Grid>
			</Grid>
